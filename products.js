...
const All = new mongoose.model('All', SchemaP);
const SignSchema = new mongoose.Schema({
  name: String,
  password: String,
  email: String,
});
SignSchema.index({ name: 1, password: 1, email: 1 }, { unique: true });

const Smodel = new mongoose.model('Smodel', SignSchema);

//Data transferred to mongodb database
// let user = [
//   {
//     id: 1,
//     title: 'iPhone 9',
...
// All.insertMany(user)
//   .then((savedItems) => {
//     console.log('Items saved:', savedItems);
//   })
//   .catch((error) => {
...
//     const del = await Smodel.deleteOne({ password: pass });
...
app.post('/submit', async (req, res) => {
  try {
    ...
    // const singleUse = await Smodel.createIndex(
    //   { name: 1, password: 1, email: 1 },
    //   { unique: true }
    // );
    console.log('One time saved');
  } catch (err) {
...
app.listen(port, () => {
  console.log(`http://localhost:${port}/fetch`);
